...
<table id="convertSumOfScaledToIndex" class="display" style="width:100%">
  ...
  <tbody>
    <tr>
      ...
      <td align="center"><input type="number" name="qri_sumScaledScores" min="0"></td>
      <td align="center">QRI <input type="number" name="qri_composite" min="0"></td>
      <td align="center"><input type="number" name="qri_percentile" min="0" max="100"></td>
      <td align="center"><input type="number" name="qri_confidence" min="90"></td>
    </tr>
    <tr>
      <td align="left">Auditory Working Memory</td>
      <td align="center"><input type="number" name="awmi_sumScaledScores" min="0"></td>
      <td align="center">AWMI <input type="number" name="awmi_composite" min="0"></td>
      <td align="center"><input type="number" name="awmi_percentile" min="0" max="100"></td>
      <td align="center"><input type="number" name="awmi_confidence" min="90"></td>
    </tr>
    <tr>
