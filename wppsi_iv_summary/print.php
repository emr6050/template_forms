...
<table id="convertSumOfScaledToIndex" class="display" style="width:100%">
  ...
  <tbody>
    <tr>
      ...
      <td align="center"><input type="number" name="vai_sumScaledScores" min="0" value="<?php echo stripslashes($record['vai_sumScaledScores']) ?>"></td>
      <td align="center">VAI <input type="number" name="vai_composite" min="0" value="<?php echo stripslashes($record['vai_composite']) ?>"></td>
      <td align="center"><input type="number" name="vai_percentile" min="0" max="100" value="<?php echo stripslashes($record['vai_percentile']) ?>"></td>
      <td align="center"><input type="number" name="vai_confidence" min="90" value="<?php echo stripslashes($record['vai_confidence']) ?>"></td>
    </tr>
    <tr>
